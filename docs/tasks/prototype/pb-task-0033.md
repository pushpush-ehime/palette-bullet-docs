...
0018の[共通契約・Fakeと引渡し状態](/tasks/prototype/pb-task-0018#handoff)を受け取り、実個体の所有・予約・消費へ接続します。同frameで確定済み予約を自然破裂より優先し、未確定要求を後から予約扱いにしません。所有保証したReserved個体の異常消失と未予約個体の通常消失は[D03](/spec/common-technology/feature-connections#failure-policy)で区別します。
