...
Mode／ConductのGameplay上の意味とライフサイクルは[Playerアクション｜モードチェンジとコンダクト](/spec/player/player-action-mode-change-and-conduct)を正本とします。現在のPlayer基盤の提供範囲・編集・接続方法は[Player Action／State基盤（Unity Visual Scripting）](/spec/common-technology/action-state-manage)と[開発基盤ガイド](https://github.com/pushpush-ehime/Palette-Bullet/blob/55d050ad9760b27bb61415a0f7d2324ee9a50bec/Docs/DEVELOPMENT.md)を参照します。
