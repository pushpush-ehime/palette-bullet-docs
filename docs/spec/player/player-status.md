...
Parrying後半の再入力受付区間から新しいParryingを開始する場合も、**新しいParryingを開始するたびにスタミナを消費します。**
...
スタミナ不足の場合、現在のParryingを先に終了してはいけません。

**新しいParryingを開始できることを確認してから、現在のParryingを終了します。**

Parry固有の再入力処理については「Playerアクション｜パリィ」を正とします。
...
同様にParryでも、新しいParryingを開始できない場合は現在の状態を維持します。
...
Parry再入力によって新しいParryingを連続して開始した場合も、Parryingが継続している間は回復しません。
